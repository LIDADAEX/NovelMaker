...
CommonUI::QssManager::QssManager(QString styleDir, QString outputFileName, QObject *parent)
    :m_lorder(new QssLorder(styleDir + '/' +outputFileName + ".qss",parent)),m_merger(new QssMerger(styleDir, outputFileName, parent)),  QObject{parent}
{
...
void CommonUI::QssManager::setStyleDir(QString styleDir, QString outputFileName)
{
    if(m_lorder != nullptr)
    {
    ...
    m_lorder = new QssLorder(styleDir + '/' +outputFileName + ".qss", this->parent());
    m_merger = new QssMerger(styleDir, outputFileName, this->parent());
}
